...
/**
 * @file libavcodec/als_data.c
 * MPEG-4 ALS Tables used by both the ALS decoder and ALS encoder.
 */
 ...
 */
const int16_t ff_als_parcor_scaled_values[128] = {
 ...
 */
const int8_t ff_als_parcor_rice_table[3][20][2] = {
